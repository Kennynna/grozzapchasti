...
export type StorageHash =
  StorageHashBase<'3bf2e8ac1ba8d51515e161eadb6941286b9cb761294f0165a7652ef7ee7f4a3f'>;
export type ExecutionHash =
  ExecutionHashBase<'8c602640d7c4ce14a2e341312c151e19a0e5c41ea130e8674d694d579934338c'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly SparePart: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly article: CodecTypes['pg/text@1']['output'] | null;
      readonly description: CodecTypes['pg/text@1']['output'] | null;
      readonly images: ReadonlyArray<CodecTypes['pg/text@1']['output']>;
      readonly price: CodecTypes['pg/int4@1']['output'];
      readonly markId: CodecTypes['pg/int4@1']['output'] | null;
      readonly modelId: CodecTypes['pg/int4@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly SparePart: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'];
      readonly article: CodecTypes['pg/text@1']['input'] | null;
      readonly description: CodecTypes['pg/text@1']['input'] | null;
      readonly images: ReadonlyArray<CodecTypes['pg/text@1']['input']>;
      readonly price: CodecTypes['pg/int4@1']['input'];
      readonly markId: CodecTypes['pg/int4@1']['input'] | null;
      readonly modelId: CodecTypes['pg/int4@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly model: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['name', 'markId'] }];
              indexes: readonly [
                {
            ...
            readonly sparePart: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['article'] }];
              indexes: readonly [
                {
                  readonly name: 'sparePart_markId_idx_683904f6';
                  readonly prefix: 'sparePart_markId_idx';
                  readonly columns: readonly ['markId'];
                  readonly unique: false;
                },
                {
                ...
                {
                  readonly name: 'sparePart_categoryId_idx_15c304f2';
                  readonly prefix: 'sparePart_categoryId_idx';
          ...
          readonly SparePart: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly name: { readonly column: 'name' };
                readonly article: { readonly column: 'article' };
                readonly description: { readonly column: 'description' };
                readonly images: { readonly column: 'images' };
